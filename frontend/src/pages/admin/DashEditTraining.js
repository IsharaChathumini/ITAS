...
import { editSingleTrainingAction, trainingLoadSingleAction } from '../../redux/actions/trainingAction';
import { useNavigate, useParams } from 'react-router-dom';
import { EDIT_TRAINING_RESET } from '../../redux/constants/trainingconstant';
...
const DashEditTraining = () => {
    ...
    const { success } = useSelector(state => state.updateTraining);

    const formik = useFormik({
        initialValues: {
            _id: singleTraining?._id,
            ...
            available: singleTraining?.available,
            trainingType: singleTraining?.trainingType?._id,
        },
        validationSchema: validationSchema,
        enableReinitialize: true,
        onSubmit: (values, actions) => {
            dispatch(editSingleTrainingAction(values))
    ...
    useEffect(() => {
        if (success && success === true) {
            setTimeout(() => {
                dispatch({ type: EDIT_TRAINING_RESET })
            ...
            <Box sx={{ height: '100%', display: "flex", alignItems: "center", justifyContent: "center", pt: 4 }}>
                ...
                <Box onSubmit={formik.handleSubmit} component="form" className='form_style border-style' >
                    <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", width: "100%" }}>
                        ...
                        <Button fullWidth variant="contained" type='submit' >Edit training</Button>
                    </Box>
                </Box>
            </Box>
...
export default DashEditTraining