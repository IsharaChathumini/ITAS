...
const SidebarAdm = () => {
    ...
    return (
        <>
            <Sidebar backgroundColor="#8B4513" style={{ borderRightStyle: "none" }}>
                        ...
                        >
                            {userInfo && userInfo.role === 1 ? (
                                ...
                                <>
                                    ...
                                    <MenuItem component={<Link to="/user/add-training" />} icon={<AddIcon />}>Apply New Training</MenuItem>
                                    <MenuItem component={<Link to="/user/trainings" />} icon={<WorkHistoryIcon />}> Applied Trainings </MenuItem>
